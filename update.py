...
SERIAL_PORT = 'COM10'  # THAY ĐỔI CỔNG COM CHO PHÙ HỢP
BAUDRATE = 115200
...
while True:
    ...
    if min(len(lx), len(rx)) > 0:
        ...
        quad = np.array([(lx[0],538),(lx[min_len-1],0),(rx[min_len-1],0),(rx[0],538)], dtype=np.int32).reshape((-1,1,2))
        ...
        warp_back = cv2.warpPerspective(birdseye, invM, (960,540))
